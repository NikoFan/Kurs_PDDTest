...
public class SignsQuiz extends AppCompatActivity {
        ...
        ans_1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (currentQuestions < questionsItems.size()-1){
                    ...
                    Intent newWindow = new Intent(SignsQuiz.this, ResultActivity.class);
    ...
    private void loadAllQuestions(){
        ...
        String jsonQuiz = loadJsonFromAsset("SignsQuestions.json");
        try{
            JSONObject jsonObject = new JSONObject(jsonQuiz);
            JSONArray questions = jsonObject.getJSONArray("signsquestions");
    ...
    public void onBackPressed(){
        MaterialAlertDialogBuilder materialAlertDialogBuilder =
                new MaterialAlertDialogBuilder(SignsQuiz.this);
        ...
        materialAlertDialogBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                ...
                startActivity(new Intent(SignsQuiz.this, MainActivity.class));
                finish();
            }
        });
